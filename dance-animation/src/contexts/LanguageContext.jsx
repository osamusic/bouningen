...
export const translations = {
  ja: {
    ...
    autoSync: '音楽連動オート制御',
    autoSyncDesc: '音楽の変化に合わせて自動で同期をオン/オフします',
    autoFigure: '音楽連動人数自動増加',
    autoFigureDesc: '音楽の盛り上がりに合わせて自動で人数が増加します',
    display: '🌙 表示',
    darkMode: 'ダークモード',
  ...
  en: {
    ...
    autoSync: 'Music-Driven Auto Control',
    autoSyncDesc: 'Automatically toggles sync based on music changes',
    autoFigure: 'Music-Driven Auto Figure Count',
    autoFigureDesc: 'Automatically increases figure count based on music intensity',
    display: '🌙 Display',
    darkMode: 'Dark Mode',
